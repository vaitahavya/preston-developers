...
export function ProjectCard({ slug, name, tag, copy, index = 0 }: Props) {
  return (
    <Link
      href={`/projects/${slug}`}
      className="group grid gap-6 border-t border-[var(--line)] py-10 md:grid-cols-12 md:items-center md:gap-10 md:py-14"
    >
      ...
      <div className="md:col-span-7">
        ...
        <p className="mt-6 text-[11px] font-semibold uppercase tracking-[0.22em] text-[var(--fg-muted)] transition group-hover:text-[var(--accent)]">
